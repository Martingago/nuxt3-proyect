<template>
    <form @submit.prevent class="d-flex flex-column container shadow rounded gap-3 p-3">
        ...
        <div class="d-flex flex-column">
            ...
            <select name="etiquetaProducto" id="etiquetaProducto">
        ...
        <div class="d-flex justify-content-between">
            <div class="d-flex flex-column">
                ...
                <span class="d-flex flex-row justify-content-center align-items-center gap-1">
                    <input type="text" @keypress="filterNonNumeric" name="precioProducto" id="precioProducto" class="text-end" v-model="precioProducto">
            ...
            <div class="d-flex gap-2">
                <div class="d-flex flex-column">
                    ...
                    <select name="decuentoProducto" id="descuentoProducto">
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <span class="d-flex gap-1"><input v-model="precioAnterior" type="number" name="precioAnterior" id="precioAnterior">
                        <p class="m-auto fs-5 fw-600">€</p>
                        </span>
                    </div>

                    <button class="btn btn-primary p-0 mt-2" @click="calcularPVP">Calcular PVP</button>
                </div>
            </div>
